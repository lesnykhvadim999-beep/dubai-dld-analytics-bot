...
DEAL_TYPE_ALIASES = {
    "sale": [
        ...
        "продажа", "купить", "покупка", "продать", "перепродажа", "сделка покупки",
        "بيع", "شراء",
        "🏠 продажа", "🏠 sale",
    ],
    "rent": [
        "rent", "rental", "lease", "leasing", "tenancy", "ejari", "let", "letting",
        "аренда", "сдать", "снять", "арендовать", "сдача", "арендный доход",
        "إيجار", "استئجار",
        "🔑 аренда", "🔑 rent",
    ],
    "both": [
...
PROPERTY_FORMAT_ALIASES = {
    ...
    "land": [
        ...
        "плоть", "плотно", "участок", "земельный участок", "ارض", "أرض",
    ],
    "plot": [
...
GOAL_ALIASES = {
    ...
    "rent_income": ["rent", "rental income", "аренда", "сдавать", "доход от аренды", "cashflow", "кэшфлоу"],
    "short_term_rent": ["short term", "short-term", "airbnb", "holiday home", "посуточно", "короткая аренда"],
    "resale": ["resale", "flip", "перепродажа", "продажа", "флип", "быстро продать"],
...
def normalize_request(
    ...
    **extra: Any,
    ...
    req.deal_type = normalize_deal_type(deal_type or combined) or "sale"
