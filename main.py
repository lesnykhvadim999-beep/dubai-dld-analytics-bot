...
def main_menu(user_id):
    """PHASE BN N1 + B070 + B073: упрощённое главное меню = core функции.
    История:
    - B070: убрана 'Лучший объект' (дубль Smart pick).
    - B073: убрана '⚡ Pro / 🌟 Супер-фишки' — юзер: 'бесполезные не нужны'.
      Хендлер pro_menu оставлен в коде на случай старых ссылок."""
    return kb([
